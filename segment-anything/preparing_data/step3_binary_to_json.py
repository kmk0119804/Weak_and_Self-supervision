...
# ============================================================================
DEFAULT_SAM_OUTPUT_ROOT = Path("/home/user/Weak_and_Self-supervision/datasets/custom_dataset/sam_output")
DEFAULT_IMAGE_ROOT = Path("/home/user/Weak_and_Self-supervision/datasets/custom_dataset/images")
DEFAULT_OUTPUT_ROOT = Path("/home/user/Weak_and_Self-supervision/datasets/custom_dataset/json")
...
def imread_unicode_gray(p: Path) -> Optional[np.ndarray]: 
